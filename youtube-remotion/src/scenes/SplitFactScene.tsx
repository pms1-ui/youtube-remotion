  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "transparent", transform: `scale(${sceneZoom})` }}>
      ...
      >
        ...
        >
          <div style={{ fontSize: isVertical ? 44 : 28, fontWeight: 500, color: "#e17055", fontFamily: "SCDream", marginBottom: 8 }}>
            {compareData.left.title}
          </div>
          <div style={{ fontSize: isVertical ? 56 : 40, fontWeight: 700, color: "#ffffff", fontFamily: "SCDream", wordBreak: "keep-all" as const, whiteSpace: "pre-line" }}>
        ...
        >
          <div style={{ fontSize: isVertical ? 44 : 28, fontWeight: 500, color: accent, fontFamily: "SCDream", marginBottom: 8 }}>
